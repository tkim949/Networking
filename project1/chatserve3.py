...
def new_client(connection, handle):
	message = ''
	chatMsg = ''
	msgFromClient = ''
...
if __name__ == "__main__":
	...
	while True:
		...
		#threading._start_new_thread(new_client,(connection, handle))
		# creating a new thread
		threading.Thread(target=new_client, args = (connection, handle)).start()
